(function () {
  ...
  function ExpandingDetailedListModule (options) {
    this.$el = options.$el
  ...
  ExpandingDetailedListModule.prototype.setupForm = function setupForm () {
  ...
  ExpandingDetailedListModule.prototype.addNewRow = function addNewRow (event) {
  ...
  ExpandingDetailedListModule.prototype.listFull = function listFull () {
    return (this.maxItems !== null && this.$container.find('li:not(.removed)').length >= this.maxItems)
  }

  ExpandingDetailedListModule.prototype.deleteRow = function deleteRow ($row, event) {
    event.preventDefault()
  ...
  ExpandingDetailedListModule.prototype.buildAddLink = function buildAddLink () {
    var $addLink = $('<a></a>')
  ...
  ExpandingDetailedListModule.prototype.insertAddLink = function insertAddLink () {
  ...
  ExpandingDetailedListModule.prototype.removeAddLink = function removeAddLink () {
    this.$addLink.remove()
  }

  ExpandingDetailedListModule.prototype.buildDeleteLink = function buildDeleteLink (i, element) {
  ...
  ExpandingDetailedListModule.prototype.buildTemplateForm = function buildTemplateForm () {
  ...
  ExpandingDetailedListModule.prototype.buildFieldName = function buildFieldName (name, newIndex) {
  ...
  ExpandingDetailedListModule.prototype.buildFieldID = function buildFieldID (id, newIndex) {
    // The following expressions are designed to match everything in the following
    // strings apart from the '[0]' index:
    //
  ...
  ExpandingDetailedListModule.prototype.getNewIndex = function getNewIndex () {
  ...
  ExpandingDetailedListModule.prototype.hasInlineLabels = function hasInlineLabels () {
  ...
  window.ProcurementHub.ExpandingDetailedListModule = ExpandingDetailedListModule
}())

$(function () {
  $('*[data-module="expanding-detailed-list"]').each(function (i, element) {
    // eslint-disable-next-line no-new
    new window.ProcurementHub.ExpandingDetailedListModule({
      $el: $(element)
    })
  })
})
