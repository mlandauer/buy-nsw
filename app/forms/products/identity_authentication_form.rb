module Products
  class IdentityAuthenticationForm < BaseForm
    ...
    validation :default, inherit: true do
      ...
      rule(authentication_types: [
        :authentication_required, :authentication_types,
      ]) do |radio, field|
        radio.true?.then(field.filled?.any_checked?)
      end
      rule(authentication_other: [
        :authentication_required, :authentication_types, :authentication_other,
